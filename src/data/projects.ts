...
export const projects: Project[] = [  {
    ...
    timeline: 'Sep 2024 – Apr 2025',    buttons: [
      { label: 'Code', url: 'https://github.com/alex8ndr/Holoportation', type: 'github' }
    ],
    size: 'medium',
    color: '#8b5cf6', // Purple
  },  {
    ...
    timeline: 'Jan 2023 – Apr 2023',    buttons: [
      { label: 'Code', url: 'https://github.com/IBGA/UniTrade', type: 'github' }
    ],
    size: 'small',
