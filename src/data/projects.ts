...
export interface Project {
  ...
  color: string;
  angle: number; // Angle in degrees (0-360) for positioning on the ring
}
...
export const projects: Project[] = [{
  ...
  size: 'large',
  color: '#3b82f6', // Blue
  angle: 315, // Top right on large ring
}, {
  id: 'vibe',
  name: 'Vibe',
  ...
  size: 'large',
  color: '#f59e0b', // Amber
  angle: 225, // Top left on large ring
}, {
  id: 'holoportation',
  name: 'Holoportation',
  description:
